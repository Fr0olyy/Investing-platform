...
```powershell
cd C:\Users\dd2sa\Desktop\Kursach-2sem\Investing-platform\backend
```
...
docker rm -f investing-platform-backend investing-platform-db investing-platform-frontend 2>$null
```
...
```powershell
docker compose exec backend python -m app.scripts.ensure_admin --email admin@example.com --password Admin12345!
```

�������� ������ ������������� admin:

```powershell
docker compose exec backend python -m app.scripts.ensure_admin --email admin@example.com --password NewPass123! --reset-password
```
...
- `POST /api/v1/system/news/refresh`
- `POST /api/v1/system/news/refresh?ticker=GAZP&per_asset_limit=10`
